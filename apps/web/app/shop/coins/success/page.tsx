    ...
    <PageShell className="flex items-start justify-center sm:items-center">
      <PageContent size="wide" variant="plain" className="w-full min-w-0">
        <div className="q-card-strong rounded-3xl p-6 text-center sm:p-10">
          <p className="text-xs font-black uppercase tracking-[0.32em] text-emerald-200">Payment Complete</p>
          <h1 className="mt-3 text-3xl font-black tracking-tight text-white sm:text-5xl">Coins incoming</h1>
          <p className="mx-auto mt-3 max-w-2xl text-sm leading-relaxed text-slate-200/85 sm:text-base">
            If you don&apos;t see the coins immediately, give it a few seconds and refresh. (Stripe webhooks can be slightly delayed.)
          </p>
