...
const TOPIC_ALLOWED_FORMATS = {
  ...
  fractions: [QUESTION_FORMATS.MULTIPLE_CHOICE, QUESTION_FORMATS.TRUE_FALSE, QUESTION_FORMATS.FILL_IN],
  percentages: [QUESTION_FORMATS.MULTIPLE_CHOICE, QUESTION_FORMATS.TRUE_FALSE, QUESTION_FORMATS.FILL_IN],
  ratios: [QUESTION_FORMATS.MULTIPLE_CHOICE, QUESTION_FORMATS.TRUE_FALSE, QUESTION_FORMATS.FILL_IN],
  geometry: [QUESTION_FORMATS.MULTIPLE_CHOICE, QUESTION_FORMATS.FILL_IN],
  graphs_functions: [QUESTION_FORMATS.MULTIPLE_CHOICE, QUESTION_FORMATS.TRUE_FALSE, QUESTION_FORMATS.FILL_IN],
